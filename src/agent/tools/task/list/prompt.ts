export const taskListToolName = 'taskList';

export function getTaskListDescription(): string {
...
- **blockedBy**: List of open task IDs that must be resolved first (tasks with blockedBy cannot be started until dependencies resolve)
