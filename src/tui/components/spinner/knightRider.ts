/* Knight Rider–style scanner animation — adapted from OpenCode (MIT)
   https://github.com/anomalyco/opencode/blob/main/packages/opencode/src/cli/cmd/tui/ui/spinner.ts */
...
function createKnightRiderTrail(options: AdvancedGradientOptions): ColorGenerator {
  ...
  const defaultRgba = defaultColor instanceof RGBA
    ? defaultColor
